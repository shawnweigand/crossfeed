                    ...
                    { feed.selected &&
                        <div className='relative group rounded overflow-hidden'>
                            ...
                            <div className="flex flex-col p-6 items-center relative" >
                                ...
                                /> */}
                                <div className={`${useColor(feed).bg} ${useColor(feed).text} size-20 rounded-full mx-auto mb-2 flex items-center justify-center text-3xl font-bold`}>
                                        {feed.name.charAt(0)}
                                </div>
                    ...
                    {!feed.selected &&
                        <div className='relative group rounded overflow-hidden'>
                            ...
                            <div className="flex flex-col p-6 items-center relative" >
                                ...
                                /> */}
                                <div className={`${useColor(feed).bg} ${useColor(feed).text} size-14 rounded-full mx-auto mb-2 flex items-center justify-center text-3xl font-bold`}>
                                        {feed.name.charAt(0)}
                                </div>
